...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Localitysearch localitysearch) {
        ...
        if(localitysearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = localitysearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = localitysearch.getFieldsearchers().iterator();
