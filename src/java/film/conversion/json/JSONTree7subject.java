...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Tree7subjectsearch tree7subjectsearch) {
        ...
        if(tree7subjectsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = tree7subjectsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = tree7subjectsearch.getFieldsearchers().iterator();
