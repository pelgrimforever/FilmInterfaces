...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Art_academysearch art_academysearch) {
        ...
        if(art_academysearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = art_academysearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = art_academysearch.getFieldsearchers().iterator();
