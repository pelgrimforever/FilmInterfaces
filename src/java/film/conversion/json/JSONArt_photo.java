...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Art_photosearch art_photosearch) {
        ...
        if(art_photosearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = art_photosearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = art_photosearch.getFieldsearchers().iterator();
