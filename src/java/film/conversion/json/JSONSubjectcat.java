...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Subjectcatsearch subjectcatsearch) {
        ...
        if(subjectcatsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = subjectcatsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = subjectcatsearch.getFieldsearchers().iterator();
