...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Arealevel2search arealevel2search) {
        ...
        if(arealevel2search.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = arealevel2search.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = arealevel2search.getFieldsearchers().iterator();
