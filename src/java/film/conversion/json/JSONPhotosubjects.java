...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Photosubjectssearch photosubjectssearch) {
        ...
        if(photosubjectssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = photosubjectssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = photosubjectssearch.getFieldsearchers().iterator();
