...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Art_subgroupsearch art_subgroupsearch) {
        ...
        if(art_subgroupsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = art_subgroupsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = art_subgroupsearch.getFieldsearchers().iterator();
