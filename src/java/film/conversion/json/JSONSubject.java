...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Subjectsearch subjectsearch) {
        ...
        if(subjectsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = subjectsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = subjectsearch.getFieldsearchers().iterator();
