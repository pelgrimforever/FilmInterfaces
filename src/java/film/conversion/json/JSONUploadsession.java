...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Uploadsessionsearch uploadsessionsearch) {
        ...
        if(uploadsessionsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = uploadsessionsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = uploadsessionsearch.getFieldsearchers().iterator();
