...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Securityprofilesearch securityprofilesearch) {
        ...
        if(securityprofilesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = securityprofilesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = securityprofilesearch.getFieldsearchers().iterator();
