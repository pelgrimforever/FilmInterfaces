...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Phototree7subjectsearch phototree7subjectsearch) {
        ...
        if(phototree7subjectsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = phototree7subjectsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = phototree7subjectsearch.getFieldsearchers().iterator();
