...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Sublocalitysearch sublocalitysearch) {
        ...
        if(sublocalitysearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = sublocalitysearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = sublocalitysearch.getFieldsearchers().iterator();
