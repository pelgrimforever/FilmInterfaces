...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Arealevel1search arealevel1search) {
        ...
        if(arealevel1search.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = arealevel1search.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = arealevel1search.getFieldsearchers().iterator();
