...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Creatorsearch creatorsearch) {
        ...
        if(creatorsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = creatorsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = creatorsearch.getFieldsearchers().iterator();
