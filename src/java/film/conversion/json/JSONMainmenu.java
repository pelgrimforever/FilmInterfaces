...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Mainmenusearch mainmenusearch) {
        ...
        if(mainmenusearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = mainmenusearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = mainmenusearch.getFieldsearchers().iterator();
