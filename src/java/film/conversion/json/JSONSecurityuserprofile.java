...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Securityuserprofilesearch securityuserprofilesearch) {
        ...
        if(securityuserprofilesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = securityuserprofilesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = securityuserprofilesearch.getFieldsearchers().iterator();
