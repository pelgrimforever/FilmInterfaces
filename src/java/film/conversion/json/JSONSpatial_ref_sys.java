...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Spatial_ref_syssearch spatial_ref_syssearch) {
        ...
        if(spatial_ref_syssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = spatial_ref_syssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = spatial_ref_syssearch.getFieldsearchers().iterator();
