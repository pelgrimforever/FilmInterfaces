...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Arealevel3search arealevel3search) {
        ...
        if(arealevel3search.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = arealevel3search.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = arealevel3search.getFieldsearchers().iterator();
