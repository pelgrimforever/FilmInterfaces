...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Art_groupsearch art_groupsearch) {
        ...
        if(art_groupsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = art_groupsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = art_groupsearch.getFieldsearchers().iterator();
