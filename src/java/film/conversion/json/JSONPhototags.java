...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Phototagssearch phototagssearch) {
        ...
        if(phototagssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = phototagssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = phototagssearch.getFieldsearchers().iterator();
