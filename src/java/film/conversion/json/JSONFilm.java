...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Filmsearch filmsearch) {
        ...
        if(filmsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = filmsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = filmsearch.getFieldsearchers().iterator();
