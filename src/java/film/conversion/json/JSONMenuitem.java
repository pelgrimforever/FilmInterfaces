...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Menuitemsearch menuitemsearch) {
        ...
        if(menuitemsearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = menuitemsearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = menuitemsearch.getFieldsearchers().iterator();
