...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Photosearch photosearch) {
        ...
        if(photosearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = photosearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = photosearch.getFieldsearchers().iterator();
