...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Filmsubjectssearch filmsubjectssearch) {
        ...
        if(filmsubjectssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = filmsubjectssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = filmsubjectssearch.getFieldsearchers().iterator();
