...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Countrysearch countrysearch) {
        ...
        if(countrysearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = countrysearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = countrysearch.getFieldsearchers().iterator();
