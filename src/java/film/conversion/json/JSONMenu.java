...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Menusearch menusearch) {
        ...
        if(menusearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = menusearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = menusearch.getFieldsearchers().iterator();
