...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Postalcodesearch postalcodesearch) {
        ...
        if(postalcodesearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = postalcodesearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = postalcodesearch.getFieldsearchers().iterator();
