...
//Custom code, do not change this line
    ...
    public static JSONObject toJSON(Uploadsessionsettingssearch uploadsessionsettingssearch) {
        ...
        if(uploadsessionsettingssearch.used()) {
            ...
            Iterator<EntityPKInterface> primarykeysI = uploadsessionsettingssearch.getPrimarykeys().iterator();
            Iterator<IFieldsearcher> fieldsearchersI = uploadsessionsettingssearch.getFieldsearchers().iterator();
